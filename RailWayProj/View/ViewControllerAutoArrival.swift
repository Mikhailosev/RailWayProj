//
//  ViewControllerAutoArrival.swift
//  RailWayProj
//
...
class ViewControllerAutoArrival: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    // MARK: Getting value from tableView into searchBar
